...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2023-08-09 16:04:46" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2023-08-09 16:04:46" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2023-08-09 16:04:46" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2023-08-09 16:04:46" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2023-08-09 16:04:46" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2023-08-09 16:04:46" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2023-08-09 16:04:46" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "copilot" ("2023-08-09 16:04:46" ("emacs" "s" "dash" "editorconfig" "jsonrpc") (:host github :repo "zerolfx/copilot.el" :files ("dist" "*.el") :package "copilot" :type git :local-repo "copilot.el")) "s" ("2023-08-09 16:04:46" nil (:type git :flavor melpa :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "dash" ("2023-08-09 16:04:46" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "editorconfig" ("2023-08-09 16:04:46" ("emacs" "nadvice") (:type git :flavor melpa :host github :repo "editorconfig/editorconfig-emacs" :package "editorconfig" :local-repo "editorconfig-emacs")) "jsonrpc" ("2023-08-09 16:04:46" ("emacs") (:type git :host github :repo "emacs-straight/jsonrpc" :files ("*" (:exclude ".git")) :package "jsonrpc" :local-repo "jsonrpc"))))
...
This allows Dash symbols to be looked up with \\[info-lookup-symbol]." t) (register-definition-prefixes "dash" '("!cdr" "!cons" "--" "->" "-a" "-butlast" "-c" "-d" "-e" "-f" "-gr" "-i" "-juxt" "-keep" "-l" "-m" "-no" "-o" "-p" "-r" "-s" "-t" "-u" "-value-to-list" "-when-let" "-zip" "dash-")) (provide 'dash-autoloads)) "editorconfig" ((editorconfig editorconfig-fnmatch editorconfig-core editorconfig-core-handle editorconfig-conf-mode editorconfig-autoloads) (autoload 'editorconfig-apply "editorconfig" "Get and apply EditorConfig properties to current buffer.
...
(fn &optional ARG)" t) (register-definition-prefixes "copilot" '("copilot-")) (register-definition-prefixes "copilot-balancer" '("copilot-balancer-")) (provide 'copilot-autoloads))))
...
("jsonrpc" "nadvice" "editorconfig" "dash" "s" "copilot" "emacs" "straight" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa")
